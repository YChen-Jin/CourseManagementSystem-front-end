...
import TeachingSectionList from '../views/teaching/Section-List.vue'
...
import SectionManage from '../views/admin/Section-Manage.vue'
...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: '/teaching/section/list',
                name: 'Teaching-Section-List',
                component: TeachingSectionList,
                meta: {
                    authRequired: true,
                    rolePermitted: ['教师', '管理员']
                }
