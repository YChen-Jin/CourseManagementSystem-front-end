...
export function getSection(pathVariable, params) {
    return request({
        url: '/sections/' + pathVariable,
        method: 'get',
        params
    })
}
...
export function getSectionsOfCourse(pathVariable, params) {
    return request({
        url: '/courses/' + pathVariable + '/sections',
        method: 'get',
        params
    })
}

export function getChaptersOfSection(pathVariable, params) {
    return request({
        url: '/sections/' + pathVariable + '/chapters',
        method: 'get',
        params
    })
}
...
export function deleteSection(pathVariable) {
    return request({
        url: '/sections/' + pathVariable,
        method: 'delete'
    })
